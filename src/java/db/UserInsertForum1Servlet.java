 ...
 * @author User
 */
@WebServlet(name = "UserInsertForum1Servlet", urlPatterns = {"/UserInsertForum1Servlet"})
public class UserInsertForum1Servlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String email = (String)session.getAttribute("login");
         ...
         try {    
            ...
            String selecttitledb = "Select title from forum_1";
            ResultSet rs;
            ...
            PreparedStatement ps = jdbcUtility.getPsInsertForum1();
            ...
            if (insertStatus == 1) {
                ...
                out.println("    window.location = './viewforum1.jsp'");
                out.println("</script>");
            }
        }
