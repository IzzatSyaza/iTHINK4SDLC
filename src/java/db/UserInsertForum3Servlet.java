 ...
 * @author User
 */
@WebServlet(name = "UserInsertForum3Servlet", urlPatterns = {"/UserInsertForum3Servlet"})
public class UserInsertForum3Servlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String email = (String)session.getAttribute("login");
         ...
         try {    
            ...
            String selecttitledb = "Select title from forum_3";
            ResultSet rs;
            ...
            PreparedStatement ps =  con.prepareStatement("INSERT INTO forum_3(email,title, date, question)" +
                                      " VALUES(?,?, NOW(), ?)"); 
            ...
            if (insertStatus == 1) {
                ...
                out.println("    window.location = './viewforum3.jsp'");
                out.println("</script>");
            }
        }
