 ...
 * @author User
 */
@WebServlet(name = "UserReplyFormServlet", urlPatterns = {"/UserReplyFormServlet"})
public class UserReplyFormServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        //SelectStudentById
        jdbcUtility.prepareSQLStatementSelectForumById();
    }
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            PreparedStatement ps = jdbcUtility.getPsSelectForumById();
	    ...
	    //set parameter and execute the statement
            ...
            while (rs.next()) {
                ...
                out.println("        <form method='post' action='UserReplyServlet'>");
                out.println("            <label>Enter your reply here:");
                out.println("            <input name='reply' type='text' value='"+ reply+ "'required/>");
                out.println("            </label>");
                out.println("            <br />"); 
                out.println("            <label>");
