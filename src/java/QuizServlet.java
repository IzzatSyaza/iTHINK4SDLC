    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try{
                ...
                rs = stmt.executeQuery("select answer from quiz1");
                ...
                String sql = "select marks from markquiz1 where email='" + email + "'";
                ResultSet resultset = statement.executeQuery(sql);
                
                if(resultset.next())
                {
                    String sq2 = "update markquiz1 set marks=" + cnt + " where email='" + email + "'";
                ...
                {
                    String sq2 = "insert into markquiz1 values(?,?)";
