...
<html lang="en">
<head>
  <title>iTHINK4SDLC MEMBUAT FORUM TOPIK 1.3</title>
  <meta charset="utf-8">
...
<table >
            <tr>
                <td>
                    <h1 style="color: white; text-align: center; padding-top: 1px;">Forum 3: Topik 1.3 Menghasilkan Satu Projek Mini Berdasarkan Situasi Penyelesaian Masalah Dengan Merujuk Fasa Pembangunan Atur Cara</h1>
                    <br>
                </td>
            </tr>
            <tr>
                <td id="reply" style="text-align:left;">
                    <div class="btn-group" >
                    <a href="viewforum3.jsp"><button class="createforum circular"> << Back</button></a>
                    </div>
                </td>
            </tr>
            <tr>
                <td style="padding-top: 10px;text-align: left;">
                    <form method="post" action="UserInsertForum3Servlet">
