...
<% 
    if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("update forum_2 set title = ?,question =? where title=?");
        ...
        <script>   
            ...
            window.location = 'viewforum2.jsp';
       </script>
    <%             
    }
...
<div id="padding"></div>
        ...
        <div id="box">
                        <div class="head1">
                <h1 style="color: white; text-align: center; padding-top: 1px;">Update Forum</h1>
                <br>
            </div>
            <form>
                    <%    
                        ...
                        pst = con.prepareStatement("select * from forum_2 where title = ?"); //user want to update question
