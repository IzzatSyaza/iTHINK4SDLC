...
<% 
    if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("update forum_reply_2 set reply = '"+reply+"' where email='"+email+"' and forumtitle='"+title+"'");
        pst.executeUpdate();  
        ...
        <script>   
            ...
            window.location = 'viewreply2.jsp?title=<%=title%>';
       </script>
    <%             
}
...
</style><title>KEMASKINI BALAS</title>
        ...
        <div id="box">
            ...
            <form>
                    <%    
                        ...
                        pst = con.prepareStatement("select * from forum_reply_2 where forumtitle = ? and id=?"); //user want to update question
                ...
                <br /> 
                    ...
                    <% }  %>
                         ...
                         <a href="viewreply2.jsp?title=<%=title%>"><button width=50px class="btn btn-info" type='button'>back</button></a>
                     </div>  
</form> 
</div>
