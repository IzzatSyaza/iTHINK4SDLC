...
#reply{
    ...
    border-bottom: 2px solid black;
        ...
        <title>ITHINK4SDLC FORUM 1.1</title>
...
<div style="padding-top: 10%"></div>
        ...
        <table>
            <tr id="bordertitle">
                <td colspan="3"><h2  style="color: white; text-align: center; "><br>Forum 1: Topik 1.1 Menggunakan Konsep Pemikiran Komputasional Dalam Pembangunan Atur Cara</h2></td>
            </tr>
            <tr>
            ...
            <%
                    ...
                    <tr >
                        <td id="reply" ><div class="btn-group" style="left: 41%">
                            <a href="updateforum.jsp?title=<%=title%>"><button class="btforum circular">Edit</button></a>
                            <a href="deleteforum.jsp?title=<%=title%>" onclick="return confirm('Are you sure you want to delete?')" ><button class="btforum circular">Delete</button></a>
                            <a href="./replyforum.jsp?title=<%=title%>"><button class="btforum circular">Reply</button></a>
                            </div></td>
                   ...
                   while(rs.next()){
                    ...
                    <tr>   
                        ...
                        <%if(session.getAttribute("login") != null){
                            ...
                            <a href="updatereply.jsp?title=<%=title%>&id=<%=(replyID.get(i))%>"><button class="btforum circular">Edit</button></a>
                            <a href="deletereply.jsp?title=<%=title%>&id=<%=(replyID.get(i))%>" onclick="return confirm('Are you sure you want to delete?')" ><button class="btforum circular">Delete</button></a>
                        </div>
                            </td> </tr>      
                          <%  }
                        }
