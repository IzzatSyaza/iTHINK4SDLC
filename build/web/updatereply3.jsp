...
<% 
    if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("update forum_reply_3 set reply = '"+reply+"' where email='"+email+"' and forumtitle='"+title+"'");
        pst.executeUpdate();  
        ...
        <div id="box">
            ...
            <form>
                    <%    
                        ...
                        pst = con.prepareStatement("select * from forum_reply_3 where forumtitle = ? and id=?"); //user want to update question
