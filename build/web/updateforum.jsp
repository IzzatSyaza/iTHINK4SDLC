...
<% 
    if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("update forum_1 set title = ?,question =? where title=?");
        ...
        <div id="box">
            ...
            <form>
                    <%    
                        ...
                        pst = con.prepareStatement("select * from forum_1 where title = ?"); //user want to update question
