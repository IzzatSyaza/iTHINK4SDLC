...
.btn-group{
    ...
    <div style="padding-top: 10%"></div>
        ...
        <table>
            <tr>
             <td colspan="3"><h2 style="color: white; text-align: center; padding-top: 1px;">Forum 1: Topik 1.1 Menggunakan Konsep Pemikiran Komputasional Dalam Pembangunan Atur Cara</h2></td>
            </tr>
            <tr>
                <td colspan="3" style="text-align:left;">
                    ...
                    <div class="btn-group" style="font-size: 17px;">
                        <a href="forumlist.jsp"><button class="createforum circular"> Back</button></a>
                            ...
                            <div class="btn-group" style="font-size: 17px">
                            <a href="createforum.jsp"><button class="createforum circular"> + Create Forum</button></a>
                        </div> 
                    <%}%>
                </td>
            </tr>
      ...
      %>
        <tr> 
            <td id="title"> <b><a href="./viewreply.jsp?title=<%= title.get(i)%>" style="color: #f2f2f2"><%=title.get(i)%></a></b> </td> 
            <td> <%= date.get(i)%> </td>
            <td> <%=name.get(i)%> </td>
        </tr>
