...
#reply{
    ...
    border-bottom: 2px solid black;
        ...
        <title>ITHINK4SDLC FORUM 1.2</title>
  ...
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <div id="tophead">
       ...
       <table>
            <tr id="bordertitle">
                <td colspan="3"><h2  style="color: white; text-align: center; "><br>Forum 2: Topik 1.2 Pelaporan Pengunaan Pemikiran Komputasional Bagi Setiap Fasa Pembangunan Atur Cara</h2></td>
            </tr>
            <tr>
                <td id="bordertitle-button" style="text-align:left;">
                    <div class="btn-group">
                        <a href="viewforum2.jsp"><button class="createforum circular"> Back</button></a>
                    </div>
                    ...
                    <%  //try{
                        ...
                        String title = "";
                        String date = "";
                        rs = st.executeQuery("select * from forum_2");
                        while(rs.next())
                        {
            ...
            <%
                    ...
                    <tr >
                        <td id="reply" ><div class="btn-group" style="left: 41%">
                            <a href="updateforum2.jsp?title=<%=title%>"><button class="btforum circular">Edit</button></a>
                            <a href="deleteforum2.jsp?title=<%=title%>" onclick="return confirm('Are you sure you want to delete?')" ><button class="btforum circular">Delete</button></a>
                            <a href="./replyforum2.jsp?title=<%=title%>"><button class="btforum circular">Reply</button></a>
                            </div></td>
            ...
            %>
                ...
                <%        
                   ...
                   //Display Replies
                   rs = st.executeQuery("select * from forum_reply_2 where forumtitle='"+title+"'");
                   ...
                   while(rs.next()){
                    ...
                    <tr>   
                        ...
                        <tr><td id="reply"><div class="btn-group" style="left: 44%;">
                            ...
                            <a href="updatereply2.jsp?title=<%=title%>&id=<%=(replyID.get(i))%>"><button class="btforum circular">Edit</button></a>
                            <a href="deletereply2.jsp?title=<%=title%>&id=<%=(replyID.get(i))%>" onclick="return confirm('Are you sure you want to delete?')"><button class="btforum circular">Delete</button></a>
                        </div>
                            </td> </tr>  
