...
<% 
    ...
    if(request.getParameter("submit")!=null)
    {
        ...
        pst = con.prepareStatement("INSERT INTO forum_reply_2(email,forumtitle,reply) VALUES(?,?,?)");
        ...
        <script>
            ...
            window.location = 'viewreply2.jsp?title=<%=forumtitle%>';
       </script>
...
<body style="background-color: #c2feff;">
    ...
    <!--create forum button-->
        <div class="btn-group" style="top: 3px; left: 450px;padding-top: 7%;">
            <a href="viewreply2.jsp?title=<%=title%>"><button class="createforum circular"> Back </button></a>
            <br> <br>
       </div> 
            ...
            <div class="head1">
                ...
                <br>
                    ...
                    <%  
                        ...
                        String name="";
                        String date = "";
                        rs = st.executeQuery("select * from forum_2 where title='"+title+"'");
