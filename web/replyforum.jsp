...
<% 
    ...
    if(request.getParameter("submit")!=null)
    {
        ...
        <script>
            ...
            window.location = 'viewreply.jsp?title=<%=forumtitle%>';
       </script>
...
<body style="background-color: #c2feff;">
    ...
    <!--create forum button-->
        <div class="btn-group" style="top: 3px; left: 450px;padding-top: 7%;">
            <a href="viewreply.jsp?title=<%=title%>"><button class="createforum circular"> Back </button></a>
            <br> <br>
       </div> 
    ...
    <!--forum title-->    
        <div id="box">
            <div class="head1">
                <h1 style="color: white; text-align: center; ">Forum 1: Topik 1.1 Menggunakan Konsep Pemikiran Komputasional Dalam Pembangunan Atur Cara</h1>
                <br>
            </div>
            ...
            <form>
                    ...
                    <label>
                        <button class="button" id="submit" name="submit" type="submit">Reply</button>
                    </label>
            </form></div>
        </div>
    </div>
