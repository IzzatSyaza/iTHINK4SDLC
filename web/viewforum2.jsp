...
#box
{
    ...
    <div style="padding-top: 10%"></div>
        <table>
        <tr>
         <td colspan="3"><h2 style="color: white; text-align: center; padding-top: 1px;">Forum 2: Topik 1.2 Pelaporan Pengunaan Pemikiran Komputasional Bagi Setiap Fasa Pembangunan Atur Cara</h2></td>
        </tr>
        <tr>
            <td colspan="3" style="text-align:left;">
                ...
                <div class="btn-group" style="font-size: 17px;">
                    <a href="forumlist.jsp"><button class="createforum circular"> Back</button></a>
                        ...
                        <div class="btn-group" style="font-size: 17px">
                        <a href="createforum2.jsp"><button class="createforum circular"> + Create Forum</button></a>
                    </div> 
                <%}%>
            </td>
        </tr>
            ...
            ResultSet rs = statement.executeQuery("Select * from forum_2");
            while(rs.next()){
      ...
      %>
        <tr> 
            <td id="title"> <b><a href="./viewreply2.jsp?title=<%= title.get(i)%>" style="color: #f2f2f2"><%=title.get(i)%></a></b> </td> 
            <td> <%= date.get(i)%> </td>
            <td> <%=name.get(i)%> </td>
        </tr>
