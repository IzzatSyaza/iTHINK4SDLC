...
<html lang="en">
<head>
  <title>iTHINK4SDLC MEMBUAT FORUM TOPIK 1.2</title>
  <meta charset="utf-8">
...
<table >
            <tr>
                <td>
                    <h1 style="color: white; text-align: center; padding-top: 1px;">Forum 2: Topik 1.2 Pelaporan Penggunaan Teknik Pemikiran Komputasional bagi Setiap Fasa Pembangunan Atur Cara</h1>
                    <br>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="padding-top: 10px;text-align: left;">
                    <form method="post" action="UserInsertForum2Servlet">
